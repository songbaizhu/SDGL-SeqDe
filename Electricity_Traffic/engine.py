...
class trainer():
    def __init__(self, device, data, distribute_data, args):
        ...
        self.optimizer1 = optim.Adam(self.model.part1.parameters(), lr=args.learning_rate, weight_decay=args.weight_decay1)
        self.optimizer2 = optim.Adam(self.model.MLP_component.parameters(), lr=args.learning_rate_mlp, weight_decay=args.weight_decay2)
