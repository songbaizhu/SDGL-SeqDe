...
parser.add_argument('--learning_rate_mlp', type=float, default=0.002, help='learning rate of STID')  # 0.001
parser.add_argument('--dropout', type=float, default=0.3, help='dropout rate')
parser.add_argument('--weight_decay1', type=float, default=0., help='weight decay rate')  # 0.0001
parser.add_argument('--weight_decay2', type=float, default=0., help='weight decay rate of STID')  # 0.0001
...
parser.add_argument('--patch_len', type=int, default=24, help='短期分量的平滑次数')
...
def main():
    ...
    if is_train:
        for i in range(1, args.epochs + 1):
            ...
            engine.scheduler1.step(valid_rse)
            engine.scheduler2.step(valid_rse)
