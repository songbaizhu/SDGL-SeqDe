...
def get_dataloader_stamp(args, normalizer='std', tod=False, dow=False, weather=False, single=True,
    ...
    # load raw st dataset
    print(args)
    data = load_st_dataset(args.dataset,args.data_path)  # B, N, D --pems3的shape是(26208, 358, 1)

    #序列间的相关性
    # corr_matrix = scipy.stats.spearmanr(data[..., 0], axis=0)[0]
    ...
    return train_dataloader, val_dataloader, test_dataloader, scaler, y_test, data_train,None
